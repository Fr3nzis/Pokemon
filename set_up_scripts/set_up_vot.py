from set_up_scripts.data_processing import DataHandler, DataProcessor
from set_up_scripts.features_ext_vot import FeatureHandler
...
def main():
    ...
    print("Data processing completato.")
